"""
Django settings for nfeweb project.
...
SECRET_KEY = "django-insecure-cubb7j5$p*y7gie%xe0$h=$lt%yqvhfs+ih7z!h4fxl$aot3+&"
...
ROOT_URLCONF = "nfeweb.config.urls"
...
WSGI_APPLICATION = "nfeweb.config.wsgi.application"
