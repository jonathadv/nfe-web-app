...
from nfeweb.nfe_reader.models import MetricUnit, Nfe, NfeItem
...
def _parse_issued_date(nfe_date: str) -> Arrow:
    return arrow.get(nfe_date.strip(), "DD/MM/YYYY HH:mm:ss", tzinfo="America/Sao_Paulo").to("UTC")
